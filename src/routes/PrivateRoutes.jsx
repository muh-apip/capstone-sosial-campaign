...
const PrivateRoutes = () => {
  return (
    <Routes>
      ...
      <Route
        path="/artikel/:id"
        element={<PrivateRoute element={<DetailArticle />} />}
      />
      <Route path="/donasi" element={<PrivateRoute element={<Donasi />} />} />
      <Route
        path="/donasi/:id"
        element={<PrivateRoute element={<DetailDonasi />} />}
      />
      <Route
        path="/input-donasi/:id"
        element={<PrivateRoute element={<InputDonasi />} />}
      />
      <Route
        path="/bayar-donasi/:id"
        element={<PrivateRoute element={<BayarDonasi />} />}
      />
      <Route path="/relawan" element={<PrivateRoute element={<Relawan />} />} />
      <Route
        path="/relawan/:id"
        element={<PrivateRoute element={<DetailRelawan />} />}
      />
      <Route
        path="/relawan/pendaftaran"
        element={<PrivateRoute element={<PendaftaranRelawan />} />}
      />
      <Route
        path="/kegiatanku"
        element={<PrivateRoute element={<Kegiatanku />} />}
      />
      <Route
        path="/presensi-kegiatan"
        element={<PrivateRoute element={<PresensiKegiatan />} />}
      />
      <Route
        path="/tentang-kami"
        element={<PrivateRoute element={<Hero />} />}
      />
      <Route
        path="/user-faq"
        element={<PrivateRoute element={<UserFAQ />} />}
      />
