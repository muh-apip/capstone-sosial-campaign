        ...
        <div className="flex-1 p-4 bg-gray-100">
          ...
          <div className="lg:w-2/3 shadow-md p-6 bg-white rounded-lg">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              Bencana alam sering kali datang tanpa peringatan, membawa
              kehancuran dan kesedihan bagi banyak orang.
            </p>
            <p className="text-gray-700 leading-relaxed mb-6">
              Begitu pula ketika gunung berapi meletus, desa-desa di sekitar
              zona bahaya sering kali dihadapkan pada tantangan besar.
            </p>
            <p className="text-gray-700 leading-relaxed mb-6">
              Ketika tsunami menghantam suatu wilayah, gelombang bantuan dari
              seluruh dunia pun datang.
            </p>
          </div>
        </div>
        <FooterHome />
